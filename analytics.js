...
(function (global) {
  ...
  function exportPDF() {
    ...
    printHtml += 'h1{font-size:22px;margin:0 0 4px}h2{font-size:16px;margin:20px 0 8px;border-bottom:2px solid #4F46E5;padding-bottom:4px}';
    ...
    printHtml += '.scard .val{font-size:20px;font-weight:700;color:#4F46E5;display:block}';
